...
'reply_to_message_id'=>$message_id,
                'text' =>"<b>HEY <a href='tg://user?id=$gId'>$firstname</a> Hit /register to use me by the way your Id is <code>$gId</code> and current date and time at Egypt 🇪🇬 Is $currentTime
This Bot Is Made With ♥️ By <code>@qqqqqqv</code> 
